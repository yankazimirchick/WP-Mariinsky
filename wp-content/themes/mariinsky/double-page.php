...
<?php get_header(); ?>
                ...
                <div class="row">
                  <div class="col-sm-7 ">
                      ...
                      <div class="slider-for">
                          <div class="item">
                              <img src="<?echo get_template_directory_uri()?>/img/appartment/DOUBLE/double-1.jpg" alt="image"  draggable="false"/>
                          </div>
     ...
     <div class="col-sm-5 margin-top-30">
            <h2 class="text-center">Double</h2>
<p>Комфортный номер на первом этаже с мини-баром и двуспальной кроватью</p>
