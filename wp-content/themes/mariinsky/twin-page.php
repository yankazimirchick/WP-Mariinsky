...
<?php get_header(); ?>
                ...
                <div class="row">
                  <div class="col-sm-7 ">
                      ...
                      <div class="slider-for">
                          <div class="item">
                              <img src="<?echo get_template_directory_uri()?>/img/appartment/TWIN/twin.jpg" alt="image"  draggable="false"/>
                          </div>
                          <div class="item">
                              <img src="<?echo get_template_directory_uri()?>/img/appartment/TWIN/non-image.png" alt="image"  draggable="false"/>
                          </div>
                          <div class="item">
                              <img src="<?echo get_template_directory_uri()?>/img/appartment/TWIN/non-image.png" alt="image"  draggable="false"/>
                          </div>
     ...
     <div class="col-sm-5 margin-top-30">
            <h2 class="text-center">TWIN</h2>
<p>Двухместный номер в котором установлены две одноместные кровати.</p>
